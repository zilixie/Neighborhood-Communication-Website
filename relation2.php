...
function list_friends() {
	...
	$friend = $conn->query("CALL LIST_FRIEND ('{$_SESSION['current_uid']}')");
	$friend = $conn->query("select * from temp;");
...
<div id="main">
  ...
  <div class="leftcolumn">
    ...
    <li class="nav-item">
      <a class="nav-link  active" style = "font-size:20px; font-weight:700" href="relation2.php">Friends</a>
    </li>
    <li class="nav-item">
