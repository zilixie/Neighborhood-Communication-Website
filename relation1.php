...
function list_hood() {
	...
	$hood = $conn->query("CALL  LIST_HOOD ('{$_SESSION['current_uid']}')");

  	if ($hood->num_rows > 0) {
    	while($row = $hood->fetch_assoc()) {
...
<div id="main">
	...
	<div class="leftcolumn">
		...
		<li class="nav-item">
		  <a class="nav-link active" style = "font-size:20px; font-weight:700" href="relation1.php">Hood</a>
		</li>
		<li class="nav-item">
		  <a class="nav-link" style = "font-size:20px; font-weight:700" href="relation2.php">Friends</a>
		</li>
		<li class="nav-item">
		  <a class="nav-link" style = "font-size:20px; font-weight:700" href="relation3.php">Neighbors</a>
		</li>
		</ul>
		<!-- contacts card -->
		<div class="card card-default" style="border-left:none;border-right:none">
