...
<div id="main">
  ...
  <div class="leftcolumn">
    ...
    <div style = "display:inline"> You will back to home page after <span style = "display:inline" id="timer"></span> seconds. </div>	<i style = "display:inline"class="fa fa-fw fa-spinner"></i>
</div>
</div>
</div>
